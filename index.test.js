...
describe('[Exercise 6] Car', () => {
  ...
  test('[16] driving the car uses gas', () => {
    ...
    focus.drive(600)
    expect(focus.drive(1)).toBe(600) //drive an extra mile three times, you're still at the limit of 600 which is 20 miles * 30 miles per gallon equals 600 see row 122
  ...
  test('[17] refueling allows to keep driving', () => {
    focus.drive(600)
    focus.refuel(10) //half tank 10*30
    focus.drive(600)
    expect(focus.odometer).toBe(900)
    focus.refuel(20) // full tank 20*30
    focus.drive(600)
